...
public abstract class Parser {
    ...
    protected void assignSymbol(String symbolName, Symbol recent, Result x) {
        List<Result> arrayIdentifiers = accumulateArrayIdentifiers(recent);
        assignSymbol(symbolName, recent, x, arrayIdentifiers);
    }
    ...
    protected void assignSymbol(String symbolName, Symbol recent, Result x, List<Result> arrayIdentifiers) {
        ...
        rhs.setResult(x);
        AuxiliaryFunctions.assignToSymbol(code, rhs, lhs, getSymbolTable());
    }
